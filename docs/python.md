...
###### `service_type`<sup>Optional</sup> <a name="cdk8s_plus_17.ExposeOptions.parameter.service_type"></a>
...
##### `rules`<sup>Optional</sup> <a name="cdk8s_plus_17.IngressV1Beta1Props.parameter.rules"></a>
...
##### `scope`<sup>Required</sup> <a name="cdk8s_plus_17.Job.parameter.scope"></a>
...
##### `scope`<sup>Required</sup> <a name="cdk8s_plus_17.Pod.parameter.scope"></a>
...
##### `add_selector` <a name="cdk8s_plus_17.Service.add_selector"></a>
...
##### `scope`<sup>Required</sup> <a name="cdk8s_plus_17.ServiceAccount.parameter.scope"></a>
...
###### `key`<sup>Required</sup> <a name="cdk8s_plus_17.StatefulSet.parameter.key"></a>
...
### IngressV1Beta1Props <a name="cdk8s_plus_17.IngressV1Beta1Props"></a>
...
cdk8s_plus_17.IngressV1Beta1Props(
  metadata: ApiObjectMetadata = None,
  default_backend: IngressV1Beta1Backend = None,
  rules: typing.List[IngressV1Beta1Rule] = None,
  tls: typing.List[IngressV1Beta1Tls] = None
...
### IngressV1Beta1Rule <a name="cdk8s_plus_17.IngressV1Beta1Rule"></a>
...
cdk8s_plus_17.IngressV1Beta1Rule(
  backend: IngressV1Beta1Backend,
  host: str = None,
  path: str = None
)
...
### IngressV1Beta1Tls <a name="cdk8s_plus_17.IngressV1Beta1Tls"></a>
...
cdk8s_plus_17.IngressV1Beta1Tls(
...
### JobProps <a name="cdk8s_plus_17.JobProps"></a>
...
### MountOptions <a name="cdk8s_plus_17.MountOptions"></a>
...
### PathMapping <a name="cdk8s_plus_17.PathMapping"></a>
...
### PodProps <a name="cdk8s_plus_17.PodProps"></a>
...
### PodSpecProps <a name="cdk8s_plus_17.PodSpecProps"></a>
...
### PodTemplateProps <a name="cdk8s_plus_17.PodTemplateProps"></a>
...
cdk8s_plus_17.PodTemplateProps(
  containers: typing.List[ContainerProps] = None,
  restart_policy: RestartPolicy = None,
  service_account: IServiceAccount = None,
  volumes: typing.List[Volume] = None,
...
### ProbeOptions <a name="cdk8s_plus_17.ProbeOptions"></a>
...
### ResourceProps <a name="cdk8s_plus_17.ResourceProps"></a>
...
### SecretProps <a name="cdk8s_plus_17.SecretProps"></a>
...
### SecretValue <a name="cdk8s_plus_17.SecretValue"></a>
...
### ServiceAccountProps <a name="cdk8s_plus_17.ServiceAccountProps"></a>
...
cdk8s_plus_17.ServiceAccountProps(
  metadata: ApiObjectMetadata = None,
  secrets: typing.List[ISecret] = None
)
```
...
### ServiceIngressV1BetaBackendOptions <a name="cdk8s_plus_17.ServiceIngressV1BetaBackendOptions"></a>
...
cdk8s_plus_17.ServiceIngressV1BetaBackendOptions(
  port: typing.Union[int, float] = None
)
```
...
### ServicePort <a name="cdk8s_plus_17.ServicePort"></a>
...
### ServicePortOptions <a name="cdk8s_plus_17.ServicePortOptions"></a>
...
cdk8s_plus_17.ServicePortOptions(
  name: str = None,
  node_port: typing.Union[int, float] = None,
  protocol: Protocol = None,
  target_port: typing.Union[int, float] = None
...
### ServiceProps <a name="cdk8s_plus_17.ServiceProps"></a>
...
### StatefulSetProps <a name="cdk8s_plus_17.StatefulSetProps"></a>
...
cdk8s_plus_17.StatefulSetProps(
  metadata: ApiObjectMetadata = None,
  containers: typing.List[ContainerProps] = None,
  restart_policy: RestartPolicy = None,
  service_account: IServiceAccount = None,
...
### VolumeMount <a name="cdk8s_plus_17.VolumeMount"></a>
...
### Container <a name="cdk8s_plus_17.Container"></a>
...
##### `add_env` <a name="cdk8s_plus_17.Container.add_env"></a>
...
###### `name`<sup>Required</sup> <a name="cdk8s_plus_17.Container.parameter.name"></a>
...
###### `value`<sup>Required</sup> <a name="cdk8s_plus_17.Container.parameter.value"></a>

- *Type:* [`cdk8s_plus_17.EnvValue`](#cdk8s_plus_17.EnvValue)

The variable value.

---

##### `mount` <a name="cdk8s_plus_17.Container.mount"></a>
...
###### `path`<sup>Required</sup> <a name="cdk8s_plus_17.Container.parameter.path"></a>
...
###### `volume`<sup>Required</sup> <a name="cdk8s_plus_17.Container.parameter.volume"></a>
...
###### `propagation`<sup>Optional</sup> <a name="cdk8s_plus_17.MountOptions.parameter.propagation"></a>
...
###### `read_only`<sup>Optional</sup> <a name="cdk8s_plus_17.MountOptions.parameter.read_only"></a>
...
###### `sub_path`<sup>Optional</sup> <a name="cdk8s_plus_17.MountOptions.parameter.sub_path"></a>
...
###### `sub_path_expr`<sup>Optional</sup> <a name="cdk8s_plus_17.MountOptions.parameter.sub_path_expr"></a>
...
### EnvValue <a name="cdk8s_plus_17.EnvValue"></a>
...
##### `from_config_map` <a name="cdk8s_plus_17.EnvValue.from_config_map"></a>

```python
import cdk8s_plus_17

cdk8s_plus_17.EnvValue.from_config_map(
...
###### `config_map`<sup>Required</sup> <a name="cdk8s_plus_17.EnvValue.parameter.config_map"></a>

- *Type:* [`cdk8s_plus_17.IConfigMap`](#cdk8s_plus_17.IConfigMap)

The config map.

---

###### `key`<sup>Required</sup> <a name="cdk8s_plus_17.EnvValue.parameter.key"></a>
...
###### `optional`<sup>Optional</sup> <a name="cdk8s_plus_17.EnvValueFromConfigMapOptions.parameter.optional"></a>
...
##### `from_process` <a name="cdk8s_plus_17.EnvValue.from_process"></a>

```python
import cdk8s_plus_17

cdk8s_plus_17.EnvValue.from_process(
  key: str,
  required: bool = None
)
```
...
###### `required`<sup>Optional</sup> <a name="cdk8s_plus_17.EnvValueFromProcessOptions.parameter.required"></a>
...
##### `from_secret_value` <a name="cdk8s_plus_17.EnvValue.from_secret_value"></a>

```python
import cdk8s_plus_17

cdk8s_plus_17.EnvValue.from_secret_value(
  key: str,
  secret: ISecret,
  optional: bool = None
)
...
###### `key`<sup>Required</sup> <a name="cdk8s_plus_17.SecretValue.parameter.key"></a>
...
###### `secret`<sup>Required</sup> <a name="cdk8s_plus_17.SecretValue.parameter.secret"></a>
...
###### `optional`<sup>Optional</sup> <a name="cdk8s_plus_17.EnvValueFromSecretOptions.parameter.optional"></a>
...
##### `from_value` <a name="cdk8s_plus_17.EnvValue.from_value"></a>

```python
import cdk8s_plus_17

cdk8s_plus_17.EnvValue.from_value(
  value: str
)
```

###### `value`<sup>Required</sup> <a name="cdk8s_plus_17.EnvValue.parameter.value"></a>
...
### IngressV1Beta1Backend <a name="cdk8s_plus_17.IngressV1Beta1Backend"></a>
...
##### `from_service` <a name="cdk8s_plus_17.IngressV1Beta1Backend.from_service"></a>

```python
import cdk8s_plus_17

cdk8s_plus_17.IngressV1Beta1Backend.from_service(
  service: Service,
  port: typing.Union[int, float] = None
)
```

###### `service`<sup>Required</sup> <a name="cdk8s_plus_17.IngressV1Beta1Backend.parameter.service"></a>
...
###### `port`<sup>Optional</sup> <a name="cdk8s_plus_17.ServiceIngressV1BetaBackendOptions.parameter.port"></a>
...
### PodSpec <a name="cdk8s_plus_17.PodSpec"></a>
...
##### `containers`<sup>Optional</sup> <a name="cdk8s_plus_17.PodSpecProps.parameter.containers"></a>
...
##### `restart_policy`<sup>Optional</sup> <a name="cdk8s_plus_17.PodSpecProps.parameter.restart_policy"></a>
...
##### `service_account`<sup>Optional</sup> <a name="cdk8s_plus_17.PodSpecProps.parameter.service_account"></a>
...
##### `volumes`<sup>Optional</sup> <a name="cdk8s_plus_17.PodSpecProps.parameter.volumes"></a>
...
##### `add_container` <a name="cdk8s_plus_17.PodSpec.add_container"></a>
...
##### `add_volume` <a name="cdk8s_plus_17.PodSpec.add_volume"></a>
...
###### `volume`<sup>Required</sup> <a name="cdk8s_plus_17.PodSpec.parameter.volume"></a>
...
### PodTemplate <a name="cdk8s_plus_17.PodTemplate"></a>
...
##### `containers`<sup>Optional</sup> <a name="cdk8s_plus_17.PodTemplateProps.parameter.containers"></a>
...
##### `restart_policy`<sup>Optional</sup> <a name="cdk8s_plus_17.PodTemplateProps.parameter.restart_policy"></a>
...
##### `service_account`<sup>Optional</sup> <a name="cdk8s_plus_17.PodTemplateProps.parameter.service_account"></a>
...
##### `volumes`<sup>Optional</sup> <a name="cdk8s_plus_17.PodTemplateProps.parameter.volumes"></a>
...
##### `pod_metadata`<sup>Optional</sup> <a name="cdk8s_plus_17.PodTemplateProps.parameter.pod_metadata"></a>
...
### Probe <a name="cdk8s_plus_17.Probe"></a>
...
##### `from_command` <a name="cdk8s_plus_17.Probe.from_command"></a>

```python
import cdk8s_plus_17

cdk8s_plus_17.Probe.from_command(
  command: typing.List[str],
  failure_threshold: typing.Union[int, float] = None,
  initial_delay_seconds: Duration = None,
  period_seconds: Duration = None,
...
###### `command`<sup>Required</sup> <a name="cdk8s_plus_17.Probe.parameter.command"></a>
...
###### `failure_threshold`<sup>Optional</sup> <a name="cdk8s_plus_17.CommandProbeOptions.parameter.failure_threshold"></a>
...
###### `initial_delay_seconds`<sup>Optional</sup> <a name="cdk8s_plus_17.CommandProbeOptions.parameter.initial_delay_seconds"></a>
...
###### `period_seconds`<sup>Optional</sup> <a name="cdk8s_plus_17.CommandProbeOptions.parameter.period_seconds"></a>
...
###### `success_threshold`<sup>Optional</sup> <a name="cdk8s_plus_17.CommandProbeOptions.parameter.success_threshold"></a>
...
###### `timeout_seconds`<sup>Optional</sup> <a name="cdk8s_plus_17.CommandProbeOptions.parameter.timeout_seconds"></a>
...
##### `from_http_get` <a name="cdk8s_plus_17.Probe.from_http_get"></a>

```python
import cdk8s_plus_17

cdk8s_plus_17.Probe.from_http_get(
  path: str,
  failure_threshold: typing.Union[int, float] = None,
  initial_delay_seconds: Duration = None,
  period_seconds: Duration = None,
...
###### `path`<sup>Required</sup> <a name="cdk8s_plus_17.Probe.parameter.path"></a>
...
###### `failure_threshold`<sup>Optional</sup> <a name="cdk8s_plus_17.HttpGetProbeOptions.parameter.failure_threshold"></a>
...
###### `initial_delay_seconds`<sup>Optional</sup> <a name="cdk8s_plus_17.HttpGetProbeOptions.parameter.initial_delay_seconds"></a>
...
###### `period_seconds`<sup>Optional</sup> <a name="cdk8s_plus_17.HttpGetProbeOptions.parameter.period_seconds"></a>
...
###### `success_threshold`<sup>Optional</sup> <a name="cdk8s_plus_17.HttpGetProbeOptions.parameter.success_threshold"></a>
...
###### `timeout_seconds`<sup>Optional</sup> <a name="cdk8s_plus_17.HttpGetProbeOptions.parameter.timeout_seconds"></a>
...
###### `port`<sup>Optional</sup> <a name="cdk8s_plus_17.HttpGetProbeOptions.parameter.port"></a>
...
### Volume <a name="cdk8s_plus_17.Volume"></a>
...
cdk8s_plus_17.Volume(
  name: str,
  config: typing.Any
)
```

##### `name`<sup>Required</sup> <a name="cdk8s_plus_17.Volume.parameter.name"></a>

- *Type:* `str`

---

##### `config`<sup>Required</sup> <a name="cdk8s_plus_17.Volume.parameter.config"></a>
...
##### `from_config_map` <a name="cdk8s_plus_17.Volume.from_config_map"></a>

```python
import cdk8s_plus_17

cdk8s_plus_17.Volume.from_config_map(
  config_map: IConfigMap,
  default_mode: typing.Union[int, float] = None,
  items: typing.Mapping[PathMapping] = None,
  name: str = None,
...
###### `config_map`<sup>Required</sup> <a name="cdk8s_plus_17.Volume.parameter.config_map"></a>
...
###### `default_mode`<sup>Optional</sup> <a name="cdk8s_plus_17.ConfigMapVolumeOptions.parameter.default_mode"></a>
...
###### `items`<sup>Optional</sup> <a name="cdk8s_plus_17.ConfigMapVolumeOptions.parameter.items"></a>
...
###### `name`<sup>Optional</sup> <a name="cdk8s_plus_17.ConfigMapVolumeOptions.parameter.name"></a>
...
###### `optional`<sup>Optional</sup> <a name="cdk8s_plus_17.ConfigMapVolumeOptions.parameter.optional"></a>
...
##### `from_empty_dir` <a name="cdk8s_plus_17.Volume.from_empty_dir"></a>

```python
import cdk8s_plus_17

cdk8s_plus_17.Volume.from_empty_dir(
  name: str,
  medium: EmptyDirMedium = None,
  size_limit: Size = None
)
...
###### `medium`<sup>Optional</sup> <a name="cdk8s_plus_17.EmptyDirVolumeOptions.parameter.medium"></a>
...
###### `size_limit`<sup>Optional</sup> <a name="cdk8s_plus_17.EmptyDirVolumeOptions.parameter.size_limit"></a>
...
### IConfigMap <a name="cdk8s_plus_17.IConfigMap"></a>

- *Extends:* [`cdk8s_plus_17.IResource`](#cdk8s_plus_17.IResource)

- *Implemented By:* [`cdk8s_plus_17.ConfigMap`](#cdk8s_plus_17.ConfigMap), [`cdk8s_plus_17.IConfigMap`](#cdk8s_plus_17.IConfigMap)
...
### IPodSpec <a name="cdk8s_plus_17.IPodSpec"></a>

- *Implemented By:* [`cdk8s_plus_17.Deployment`](#cdk8s_plus_17.Deployment), [`cdk8s_plus_17.Job`](#cdk8s_plus_17.Job), [`cdk8s_plus_17.Pod`](#cdk8s_plus_17.Pod), [`cdk8s_plus_17.PodSpec`](#cdk8s_plus_17.PodSpec), [`cdk8s_plus_17.PodTemplate`](#cdk8s_plus_17.PodTemplate), [`cdk8s_plus_17.StatefulSet`](#cdk8s_plus_17.StatefulSet), [`cdk8s_plus_17.IPodSpec`](#cdk8s_plus_17.IPodSpec), [`cdk8s_plus_17.IPodTemplate`](#cdk8s_plus_17.IPodTemplate)
...
##### `add_container` <a name="cdk8s_plus_17.IPodSpec.add_container"></a>
...
##### `add_volume` <a name="cdk8s_plus_17.IPodSpec.add_volume"></a>
...
###### `volume`<sup>Required</sup> <a name="cdk8s_plus_17.IPodSpec.parameter.volume"></a>
...
### IPodTemplate <a name="cdk8s_plus_17.IPodTemplate"></a>

- *Extends:* [`cdk8s_plus_17.IPodSpec`](#cdk8s_plus_17.IPodSpec)

- *Implemented By:* [`cdk8s_plus_17.Deployment`](#cdk8s_plus_17.Deployment), [`cdk8s_plus_17.Job`](#cdk8s_plus_17.Job), [`cdk8s_plus_17.PodTemplate`](#cdk8s_plus_17.PodTemplate), [`cdk8s_plus_17.StatefulSet`](#cdk8s_plus_17.StatefulSet), [`cdk8s_plus_17.IPodTemplate`](#cdk8s_plus_17.IPodTemplate)
...
### IResource <a name="cdk8s_plus_17.IResource"></a>

- *Implemented By:* [`cdk8s_plus_17.ConfigMap`](#cdk8s_plus_17.ConfigMap), [`cdk8s_plus_17.Deployment`](#cdk8s_plus_17.Deployment), [`cdk8s_plus_17.IngressV1Beta1`](#cdk8s_plus_17.IngressV1Beta1), [`cdk8s_plus_17.Job`](#cdk8s_plus_17.Job), [`cdk8s_plus_17.Pod`](#cdk8s_plus_17.Pod), [`cdk8s_plus_17.Resource`](#cdk8s_plus_17.Resource), [`cdk8s_plus_17.Secret`](#cdk8s_plus_17.Secret), [`cdk8s_plus_17.Service`](#cdk8s_plus_17.Service), [`cdk8s_plus_17.ServiceAccount`](#cdk8s_plus_17.ServiceAccount), [`cdk8s_plus_17.StatefulSet`](#cdk8s_plus_17.StatefulSet), [`cdk8s_plus_17.IConfigMap`](#cdk8s_plus_17.IConfigMap), [`cdk8s_plus_17.IResource`](#cdk8s_plus_17.IResource), [`cdk8s_plus_17.ISecret`](#cdk8s_plus_17.ISecret), [`cdk8s_plus_17.IServiceAccount`](#cdk8s_plus_17.IServiceAccount)
...
### ISecret <a name="cdk8s_plus_17.ISecret"></a>

- *Extends:* [`cdk8s_plus_17.IResource`](#cdk8s_plus_17.IResource)

- *Implemented By:* [`cdk8s_plus_17.Secret`](#cdk8s_plus_17.Secret), [`cdk8s_plus_17.ISecret`](#cdk8s_plus_17.ISecret)
...
### IServiceAccount <a name="cdk8s_plus_17.IServiceAccount"></a>

- *Extends:* [`cdk8s_plus_17.IResource`](#cdk8s_plus_17.IResource)

- *Implemented By:* [`cdk8s_plus_17.ServiceAccount`](#cdk8s_plus_17.ServiceAccount), [`cdk8s_plus_17.IServiceAccount`](#cdk8s_plus_17.IServiceAccount)
...
#### `DEFAULT` <a name="cdk8s_plus_17.EmptyDirMedium.DEFAULT"></a>
...
#### `MEMORY` <a name="cdk8s_plus_17.EmptyDirMedium.MEMORY"></a>
...
#### `ALWAYS` <a name="cdk8s_plus_17.ImagePullPolicy.ALWAYS"></a>
...
#### `IF_NOT_PRESENT` <a name="cdk8s_plus_17.ImagePullPolicy.IF_NOT_PRESENT"></a>
...
#### `NEVER` <a name="cdk8s_plus_17.ImagePullPolicy.NEVER"></a>
...
#### `NONE` <a name="cdk8s_plus_17.MountPropagation.NONE"></a>
...
#### `HOST_TO_CONTAINER` <a name="cdk8s_plus_17.MountPropagation.HOST_TO_CONTAINER"></a>
...
#### `BIDIRECTIONAL` <a name="cdk8s_plus_17.MountPropagation.BIDIRECTIONAL"></a>
...
#### `ORDERED_READY` <a name="cdk8s_plus_17.PodManagementPolicy.ORDERED_READY"></a>

---


#### `PARALLEL` <a name="cdk8s_plus_17.PodManagementPolicy.PARALLEL"></a>
...
#### `TCP` <a name="cdk8s_plus_17.Protocol.TCP"></a>

---


#### `UDP` <a name="cdk8s_plus_17.Protocol.UDP"></a>

---


#### `SCTP` <a name="cdk8s_plus_17.Protocol.SCTP"></a>
...
#### `ALWAYS` <a name="cdk8s_plus_17.RestartPolicy.ALWAYS"></a>
...
#### `ON_FAILURE` <a name="cdk8s_plus_17.RestartPolicy.ON_FAILURE"></a>
...
#### `NEVER` <a name="cdk8s_plus_17.RestartPolicy.NEVER"></a>
...
#### `CLUSTER_IP` <a name="cdk8s_plus_17.ServiceType.CLUSTER_IP"></a>
...
#### `NODE_PORT` <a name="cdk8s_plus_17.ServiceType.NODE_PORT"></a>
...
#### `LOAD_BALANCER` <a name="cdk8s_plus_17.ServiceType.LOAD_BALANCER"></a>
...
#### `EXTERNAL_NAME` <a name="cdk8s_plus_17.ServiceType.EXTERNAL_NAME"></a>
